...
public class Payment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        var.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!menu_name.equals("장바구니")){
                    ...
                    startActivity(i);
                    Toast.makeText(Payment.this, "장바구니에 저장되었습니다.", Toast.LENGTH_SHORT).show();
                }else{
        ...
        payment.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Payment.this, pay_name.get(position) + "가 장바구니에서 삭제되었습니다.", Toast.LENGTH_LONG).show();

                pay_name.remove(position);
                pay_price.remove(position);
                pay_content.remove(position);
                    ...
                    if (menu_name.equals("장바구니")) {
                        ...
                        for (String n : pay_name) {
                            ...
                            if (res.equals(n)) {
                                ...
                                myTTS.speak(res + "메뉴가 장바구니에서 삭제되었습니다.", TextToSpeech.QUEUE_ADD, null);
